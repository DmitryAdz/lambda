...
public class SampleData {
	...
	public static final Artist testArtist = new Artist("The Test Artist", "London");
	...
	public static final Album testShortAlbum = new Album("test Short Album", asList(new Track("test short track", 65)), asList(testArtist));
	...
	public static List<Album> albumList = Arrays.asList(aLoveSupreme, sampleShortAlbum, testShortAlbum, manyTrackAlbum);
	...
	public static final List<Artist> allArtists = Arrays.asList(johnColtrane, johnLennon, paulMcCartney, georgeHarrison, ringoStarr, testArtist);
